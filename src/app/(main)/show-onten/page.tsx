...
const bg = "https://gateway.telewebion.com/sites/default/files/images/backgrounds/1403/%D8%B3%D8%B1%D8%B2%D9%85%DB%8C%D9%86-%D9%85%D8%A7%D8%AF%D8%B1%DB%8C-%D9%81%D8%B5%D9%84-%D8%B3%D9%88%D9%85-3_0.jpg"
export default async function ShowOnten() {
  return (
    <div className="overflow-hidden">
    <div className="w-full h-[410px] relative flex py-4 md:py-2 bg-center bg-cover justify-center items-center bg-gradient-to-r from-[#221D1F] to-[#341173]" style={{backgroundImage: `url(${bg})`, backgroundRepeat: "no-repeat"}}>
