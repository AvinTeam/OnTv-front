          ...
          <div className="lg:container mx-auto my-5 lg:grid lg:grid-cols-12 gap-2">
            <div className="flex flex-col lg:col-span-9 2xl:col-span-10">
              <div className="flex flex-col gap-3 lg:gap-0 pb-4 md:pb-10 lg:pb-0 bg-gradient-to-l lg:bg-none to-80% from-[#341173] to-[#221D1F]">
                ...
                <div className="md:mt-4 container text-white rounded-[12px] py-1 md:py-6 lg:py-2 xl:py-2 px-4 md:px-0 h-[180px] md:h-[150px] lg:h-[170px] xl:h-[170px] 2xl:h-auto">
                  <div className="flex flex-col justify-between">
                    <h1 className="text-link-footer-title text-[11px] md:text-sm lg:text-xl">
                      مجری شبکه ورزش به حواشی پرونده فساد در فوتبال واکنش نشان
                      داد
                    </h1>
                    <p className="text-[#606770] text-xs md:text-sm mt-3">
                      طلب آمرزش، عرض تسلیت، ابراز همدردی، توجه به حضور پرشور
                      مردم در مراسم تشییع شهدای خدمت، حمایت شهید جمهور از فلسطین
                      و معمای انگشتر ایشان
                    </p>
                  </div>
                  <div className="mt-6">
