      ...
      <main className="flex flex-col lg:grid lg:grid-cols-12 mt-4 container gap-6 bg-white p-4 md:p-8 rounded-[5px]">
        ...
        <div className="col-span-10 text-justify mb-10">
          ...
          <p className="pt-8 text-input-text">
            ...
            آن نیوز را به صورت منحصر به فرد شناسایی نمود. برای نمونه می توان به
          ...
          <p className="pt-6 text-input-text">
            ...
            ورود به آن به عنوان کاربر آن نیوز شناخته خواهید شد و کلیه اطلاعات
            مذکور و اطلاعاتی مانند تراکنش ها٬ پرداخت ها و اطلاعات فردی شما در
            اختیار آن نیوز خواهد بود. لازم به ذکر است که این موارد تنها موارد
          ...
          <p className="pt-6 text-input-text">
            محدودیت دسترسی به اطلاعات آن نیوز دسترسی کارمندان خود به اطلاعات
            ...
            رمز شده در پایگاه داده های آن نیوز نگهداری شده و در فرآیند رمزگذاری
          ...
          <p className="pt-6 text-input-text">
            ...
            بایستی به تیم پشتییبانی ما به آدرس on-news@mail.com ایمیل زده
            شود و با پرکردن ایمیل در فیلد مربوط به عضویت این کار انجام نخواهد شد
          </p>
          <p className="pt-6 text-input-text">
            با ما با مشخصات زیر تماس بگیرید ایمیل: on-news@mail.com
            آدرس: تهران - تهران - خیابان - کوچه
            تلفن تماس: ۴۴۴۴۴۴۴( ۴ خط)
          </p>
        </div>
      </main>
    </div>
